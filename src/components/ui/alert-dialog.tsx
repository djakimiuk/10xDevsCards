...
>(({ ...props }, ref) => <AlertDialogPrimitive.Root ref={ref} data-slot="alert-dialog" {...props} />);
...
>(({ ...props }, ref) => <AlertDialogPrimitive.Portal ref={ref} data-slot="alert-dialog-portal" {...props} />);
